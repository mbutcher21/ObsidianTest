...
export declare class Content {
     ...
     */
    getMacroBodyByHash<T = Models.MacroInstance>(parameters: Parameters.GetMacroBodyByHash, callback: Callback<T>): Promise<void>;
    /**
     * Returns the body of a macro (in storage format) with the given hash. This resource is primarily used by connect
     * applications that require the body of macro to perform their work.
     *
     ...
     * macroId. This will allow add ons to work during the migration period.
     */
    getMacroBodyByHash<T = Models.MacroInstance>(parameters: Parameters.GetMacroBodyByHash, callback?: never): Promise<T>;
    /**
    ...
    /** Adds a list of labels to the specified content. The body is the json representation of the list. */
    addLabelsToContent<T = Pagination<Models.Label>>(parameters: Parameters.AddLabelsToContent, callback?: never): Promise<T>;
    /** Deletes a labels to the specified content. */
    deleteLabelWithQueryParam<T = void>(parameters: Parameters.DeleteLabelWithQueryParam, callback: Callback<T>): Promise<void>;
    /** Deletes a labels to the specified content. */
    deleteLabelWithQueryParam<T = void>(parameters: Parameters.DeleteLabelWithQueryParam, callback?: never): Promise<T>;
    /**
     ...
     */
    deleteLabel<T = void>(parameters: Parameters.DeleteLabel, callback: Callback<T>): Promise<void>;
    /**
     * Deletes a labels to the specified content. When calling this method through REST the label parameter doesn't accept
     * "/" characters in label names, because of security constraints. For this case please use the query parameter
     * version of this method (/content/{id}/label?name={label}Responses
    ...
    getRestrictionsByOperation<T = Models.RestrictionsByOperation>(parameters: Parameters.GetRestrictionsByOperation, callback: Callback<T>): Promise<void>;
    /** Returns info about all restrictions by operation */
    getRestrictionsByOperation<T = Models.RestrictionsByOperation>(parameters: Parameters.GetRestrictionsByOperation, callback?: never): Promise<T>;
